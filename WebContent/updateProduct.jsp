						...
						<tr>
							...
							<td><select name="type"
								...
								value="<%=product.getProdType() %>">
									<option value="mobile">IT</option>
									<option value="tv">FOOD AND SNACKS</option>
									<option value="camera">AUTOMOBILE</option>
									<option value="laptop">ELECTRONICS</option>
									<option value="tablet">CHEMICAL</option>
									<option value="speaker">GARMENTS</option>
