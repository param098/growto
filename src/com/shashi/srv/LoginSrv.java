...
public class LoginSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("login srv1111111111111111111111111111111");
		...
		else if(userType.equals("customer")){  //Login as customer
			System.out.println("login srvvvvvvvvvvvvvvvvvvvvvvvvvvvv");
		...
		else if(userType.equals("mentor")){  //Login as customer
		...
		else if(userType.equals("startupOwner")){  //Login as customer
			 ...
			 if(status.equalsIgnoreCase("valid")) {
				 ...
				 RequestDispatcher rd = request.getRequestDispatcher("startupHome.jsp");
