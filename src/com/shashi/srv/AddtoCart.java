...
/*
		...
		*/
		...
		String username = (String)session.getAttribute("username");
		String password = (String)session.getAttribute("password");
	System.out.println("add cartttttttttttttttttttt");
		if(username == null || password==null){
		...
		System.out.println("piddddd"+prodId);
		System.out.println("pqtyy"+pQty);
		CartDaoImpl cart = new CartDaoImpl();
		...
		int cartQty = cart.getProductCount(username,prodId);
		
		pQty += cartQty;
		System.out.println("92line"+pQty);
		...
		if(availableQty < pQty ) {
			...
			if(availableQty == 0) {
				...
				cart.updateProductToCart(username, prodId, availableQty);
			...
			String status = cart.updateProductToCart(username, prodId, pQty);
